...
# Basic script to prepare a Ubuntu machine to run Ebla Node using docker.
...
# Download Ebla Scripts
cd ~/
wget https://github.com/EBLA-network/ebla-ops/archive/refs/heads/master.zip
sudo apt install -y unzip
unzip master.zip
rm -f master.zip

# Start Ebla container
case nodetype in

	"mainnet")
		cd ~/ebla-ops-master/ebla_compose_mainnet
